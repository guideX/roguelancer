    ...
    public sealed class SaveGameManager
    {
        ...
        public List<SaveMissionData> CaptureMissions(IEnumerable<Mission> missions)
        {
            ...
            foreach (var mission in missions)
            {
                ...
                result.Add(new SaveMissionData
                {
                    ...
                    EconomicEscort = mission.IsEconomicEscort,
                    EconomicShipmentTraderIdentity = mission.EconomicShipmentTraderIdentity ?? string.Empty,
                    EconomicShipmentRouteId = mission.EconomicShipmentRouteId ?? string.Empty,
                    EconomicShipmentValue = mission.EconomicShipmentValue,
        ...
        private static Mission CreateMissionFromSave(SaveMissionData data, List<string> warnings)
        {
            ...
            return Mission.CreateRestored(
                ...
                data.EconomicEscort,
                data.EconomicShipmentTraderIdentity,
                data.EconomicShipmentRouteId,
                data.EconomicShipmentValue,
