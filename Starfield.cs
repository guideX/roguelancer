...
namespace Roguelancer
{
    ...
    public class Starfield
    {
        ...
        public Starfield(GraphicsDevice graphicsDevice, int starCount = 5000)
        {
            ...
            // Generate stars with varied characteristics
        ...
        private void DrawStarsWithMotion(Matrix view, Matrix projection, Vector3 velocity, float speed)
        {
            ...
            // Starts very small at low speeds, grows with speed
            float speedFactor = MathHelper.Clamp(speed / 50f, 0f, 1f); // Normalize speed (50 units = full effect)
            float baseStreakLength = speed * 0.3f * speedFactor; // Scales with speed
            float streakLength = Math.Min(baseStreakLength, 100f); // Cap maximum streak length
