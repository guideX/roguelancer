...
using Rougelancer.Particle.System.Emitters;
...
namespace Rougelancer.Particle.System {
    public class clsProjectile {
        ...
        private clsExplosionParticleSystem explosionParticleSystem;
        private clsExplosionSmokeParticleSystem explosionSmokeParticleSystem;
        private Vector3 position;
        private Vector3 velocity;
        private float age;
        public clsTrailEmitter lTrailEmitter { get; set; }
        public clsProjectile(clsExplosionParticleSystem explosionParticleSystem, clsExplosionSmokeParticleSystem explosionSmokeParticleSystem, clsProjectileTrailParticleSystem projectileTrailParticleSystem) {
            ...
            lTrailEmitter = new clsTrailEmitter(trailParticlesPerSecond, position);
